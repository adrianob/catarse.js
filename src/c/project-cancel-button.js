...
const projectCancelButton = {
    ...
    view(ctrl, args) {
        return m('div', [
            ...
            m(".before-footer", 
                m(".w-container", 
                    m("a.btn.btn-inline.btn-no-border.btn-small.btn-terciary.u-marginbottom-20.u-right.w-button[href='javascript:void(0);']", {onclick: ctrl.displayCancelModal.toggle, style: {"transition": "all 0.5s ease 0s"}},
                        [
