...
window.c = function() {
    ...
    var contributionDetail = m.postgrest.model("contribution_details"), contributions = m.postgrest.model("contributions"), teamTotal = m.postgrest.model("team_totals"), projectDetail = m.postgrest.model("project_details"), projectContributionsPerDay = m.postgrest.model("project_contributions_per_day"), projectContributionsPerLocation = m.postgrest.model("project_contributions_per_location"), teamMember = m.postgrest.model("team_members");
    ...
    return {
        controller: function(args) {
            ...
            var l = m.postgrest.loaderWithToken(builder.model.patchOptions(h.idVM.parameters(), data)), updateItem = function() {
